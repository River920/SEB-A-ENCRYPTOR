...
if charCode = 116 then str = ("4")
if charCode = 121 then str = ("7")
if charCode = 117 then str = ("8")
if charCode = 105 then str = ("3")
if charCode = 111 then str = ("5")
if charCode = 112 then str = ("9")
if charCode = 97 then str = ("6")
if charCode = 115 then str = ("1")
if charCode = 100 then str = ("2")
...
Set file = fso.CreateTextFile(currentDir&"/e-out.txt")
